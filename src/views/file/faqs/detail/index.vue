<template>
  <div class="cate-edit detail">
    <a-form ref="formRef" size="medium" :model="form" layout="horizontal" :auto-label-width="true">
      <div class="card-wrap">
        <a-card title="FAQS详细信息编辑" :bordered="false">
          <a-form-item
            field="pubtime"
            label="发布时间"
            :content-flex="false"
          ...
          <a-form-item
            ...
            label="FAQS标题"
            :content-flex="false"
            :rules="[{required: true, message: '请填写FAQS标题', type: 'string'}]"
          >
            <a-row class="full-width">
              <a-col :span="15">
          ...
          <a-form-item field="cate" label="FAQS图片" :content-flex="false">
          ...
          <a-form-item label="FAQS内容" :content-flex="false">
            <a-row class="full-width">
              <a-col :span="22">
