...
<script setup lang="ts" name="Ecerplay">
import { loadscript } from '@/utils/common'
loadscript('https://cdn.bootcdn.net/ajax/libs/jquery/3.5.0/jquery.min.js')
...
@import 'https://vodcdn.ecerimg.com/resource/player/video-js-pc.min.css';
