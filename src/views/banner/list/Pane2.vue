  ...
  <div class="banner-detail">
    <a-form class="com-form" ref="formRef" size="medium" :model="form" layout="horizontal" :auto-label-width="true">
      ...
      <a-form-item label="Products页" :content-flex="false">
        <a-row class="full-width">
          <div class="dra-wrap-b">
              <a-col :span="11" class="pic-item" v-for="(element, index) in fileList2" :key="index">
                <span class="arco-upload-list-picture">
                  <img :src="element.url" :alt="element.name" />
                  <div class="arco-upload-list-picture-mask">
                    <div class="arco-upload-list-picture-operation">
                      <span class="arco-upload-icon arco-upload-icon-remove">
                        <icon-delete :size="20" @click="picListDel(element, 2)" />
                      </span>
                    </div>
                  </div>
                </span>
              </a-col>
              <a-col :span="11" v-show="fileList2.length<1">
                <a-upload
                  multiple
                  :with-credentials="true"
                  ...
                  ref="uploadRef"
                  :data="{ type: '4' }"
                  @success="(res)=>{ successUpload(res, 2) }"
                  draggable
                  :action="picUrl"
                />
              </a-col>
      ...
      <a-form-item label="About Us页" :content-flex="false">
        <a-row class="full-width">
          <div class="dra-wrap-b">
              <a-col :span="11" class="pic-item" v-for="(element, index) in fileList3" :key="index">
                <span class="arco-upload-list-picture">
                  <img :src="element.url" :alt="element.name" />
                  <div class="arco-upload-list-picture-mask">
                    <div class="arco-upload-list-picture-operation">
                      <span class="arco-upload-icon arco-upload-icon-remove">
                        <icon-delete :size="20" @click="picListDel(element, 3)" />
                      </span>
                    </div>
                  </div>
                </span>
              </a-col>
              <a-col :span="11" v-show="fileList3.length<1">
                <a-upload
                  multiple
                  :with-credentials="true"
                  ...
                  ref="uploadRef"
                  :data="{ type: '4' }"
                  @success="(res)=>{ successUpload(res, 3) }"
                  draggable
                  :action="picUrl"
                />
              </a-col>
      ...
      <a-form-item label="Contact Us页" :content-flex="false">
        <a-row class="full-width">
          <div class="dra-wrap-b">
              <a-col :span="11" class="pic-item" v-for="(element, index) in fileList4" :key="index">
                <span class="arco-upload-list-picture">
                  <img :src="element.url" :alt="element.name" />
                  <div class="arco-upload-list-picture-mask">
                    <div class="arco-upload-list-picture-operation">
                      <span class="arco-upload-icon arco-upload-icon-remove">
                        <icon-delete :size="20" @click="picListDel(element, 4)" />
                      </span>
                    </div>
                  </div>
                </span>
              </a-col>
              <a-col :span="11" v-show="fileList4.length<1">
                <a-upload
                  multiple
                  :with-credentials="true"
                  ...
                  ref="uploadRef"
                  :data="{ type: '4' }"
                  @success="(res)=>{ successUpload(res, 4) }"
                  draggable
                  :action="picUrl"
                />
              </a-col>
      ...
      <a-form-item label="新闻页" :content-flex="false">
        <a-row class="full-width">
          <div class="dra-wrap-b">
              <a-col :span="11" class="pic-item" v-for="(element, index) in fileList5" :key="index">
                <span class="arco-upload-list-picture">
                  <img :src="element.url" :alt="element.name" />
                  <div class="arco-upload-list-picture-mask">
                    <div class="arco-upload-list-picture-operation">
                      <span class="arco-upload-icon arco-upload-icon-remove">
                        <icon-delete :size="20" @click="picListDel(element, 5)" />
                      </span>
                    </div>
                  </div>
                </span>
              </a-col>
              <a-col :span="11" v-show="fileList5.length<1">
                <a-upload
                  multiple
                  :with-credentials="true"
                  ...
                  ref="uploadRef"
                  :data="{ type: '4' }"
                  @success="(res)=>{ successUpload(res, 5) }"
                  draggable
                  :action="picUrl"
                />
              </a-col>
